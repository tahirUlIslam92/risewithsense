  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-3xl p-8 max-w-sm mx-4 text-center shadow-2xl">
        ...
        <p className="text-sm text-[#999] mb-6">Sign in to personalize your experience and track your orders.</p>
        
        <button
          onClick={signInWithGoogle}
          className="w-full py-4 bg-[#1A1A1A] text-white rounded-full text-sm font-medium hover:bg-[#8B7355] transition-colors flex items-center justify-center gap-2"
        >
